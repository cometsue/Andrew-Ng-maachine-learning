...
![](https://cdn.jsdelivr.net/gh/cometsue/images/AN_ML/1.3 housing price prediction.png)

**分类问题：**预测离散值的输出，比如判断肿瘤是良性还是恶性，判断西瓜是好瓜还是坏瓜等等。

![](https://cdn.jsdelivr.net/gh/cometsue/images/AN_ML/1.3 Breast cancer(maligant, benign).png)
